...
import 'package:umplay/core/components/icon_background_widget.dart';
import 'package:umplay/core/components/view_all_label_component.dart';
import 'package:umplay/core/constants/constant.dart';
import 'package:umplay/core/constants/images.dart';
import 'package:umplay/features/screens/search/component/songs_search_component.dart';
    ...
    return AppScaffold(
      ...
      body: AnimatedScrollView(
        children: [
          ...
          20.height,
          ViewAllLabel(label: 'Popular Songs', isShowAll: false)
              .paddingSymmetric(horizontal: 16),
