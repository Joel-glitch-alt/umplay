          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                PodcastDetailScreen(podCastListData: podcastListData).launch(
                    context,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(podcastListData.titleName.validate(),
                            style: primaryTextStyle(),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis),
                        6.height,
                        Marquee(
                            child: Text(podcastListData.subTitleName.validate(),
                ...
                Row(
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(getEpisodeListData.titleName.validate(),
                            style: boldTextStyle(),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis),
                        Marquee(
                            child: Text(
                                getEpisodeListData.subTitleName.validate(),
                                style: secondaryTextStyle())),
                        8.height,
                        RichTextWidget(
                          list: [
                            TextSpan(
                                text: getEpisodeListData.episodeDate.validate(),
                                style: secondaryTextStyle()),
                            if (getEpisodeListData.episodeDate
                                .validate()
                                .isNotEmpty)
                              TextSpan(
                                  text: ' | ', style: secondaryTextStyle()),
                            TextSpan(
                                text: getEpisodeListData.episodeTime.validate(),
                                style: secondaryTextStyle()),
                          ],
                        ),
                      ],
